...
# nohup uv run mcp_example_server.py & langGraph_basic_learning/mcp_example_server.py
    # nohup python  langGraph_basic_learning/mcp_example_server.py > log.mcp_example_server 2>&1 & 
